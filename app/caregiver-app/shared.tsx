...
export function BottomCTA({
  ...
  return (
    <div className="fixed bottom-0 left-1/2 z-[9999] w-full max-w-[430px] -translate-x-1/2 border-t border-slate-200 bg-white px-4 py-3">
      <Button
...
export function BottomCTAAboveNav({
  label,
  onClick,
  disabled,
}: {
